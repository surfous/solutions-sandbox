...
preferences(oauthPage: "oauthPage") {
	...
	page(name: "oauthPage", title: "", nextPage: "instructionPage") {
		...
		section("") {
			...
			// TODO: uncoment for routines // input "routinesEnabled", options: [[(true): "Yes"]], type: "enum", title: "Enable Routines?", defaultValue: false, multiple: false, required: false
		}
		section() {
			href(name: "href",
					title: "Uninstall",
...
Echo works with devices such as lights, switches, thermostats, and more, including SmartThings Routines. And, with our custom skill, SmartThings Extras, you'll also be able to control locks and Smart Home Monitoring.'''
			...
			href(name: "href",
				title: "Connect my account",
				required: false,
				style: "embedded",
				description: "Tap here to enable this skill in Alexa and link it to your SmartThings account",
